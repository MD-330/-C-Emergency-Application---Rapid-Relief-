            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
              Expanded(
                child: Text(
                  ...
                  softWrap: true,
                  style: TextStyle(
                      color: AppColors.black.withOpacity(.6), fontWeight: FontWeight.bold, height: 1.5, fontSize: 12),
                ),
              )
            ]),
          )
    ...
    return Stack(
      children: <Widget>[
        Column(children: <Widget>[
          Container(
              padding: EdgeInsets.only(top: 50, right: 30, left: 30, bottom: 15),
              height: 130,
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Expanded(child: getServices('trafficPolice', Services.trafficPolice)),
                            ],
                          ),
                        ),
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Expanded( child: getServices('naturalDisasters', Services.naturalDisasters)),
                            ],
                          ),
                        ),
                      ],
