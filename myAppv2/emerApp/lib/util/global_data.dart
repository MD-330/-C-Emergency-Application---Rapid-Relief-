...
class GlobalData {
   ...
   static final String mapStrokeSvg = _strokeSvgPath + "map_svg.svg"; // variables are strings that hold the file paths of SVG images
   static final String logo = "assets/Images/logo2.png";//variables hold the file paths of PNG images
   static final String logoWait = "assets/Images/logoWait.png";

   static UserModel currentUser=new UserModel(); //`currentUser`instance of the `UserModel`represents the current user of the application
   static String cateName=''; //variables to hold the names of categories and reports, respectively
   static String reportName='';
   //holds the URL of an image representing the user's profile picture
static String globalProfile='https://firebasestorage.googleapis.com/v0/b/savior-mobile.appspot.com/o/user_images%2Fuser.png?alt=media&token=15f31ce4-40b4-485a-966e-ea94e9106a42';
   ...
   static String reportAddress=   ''; //holds the address of a report
...
//this code provides a centralized location for storing and accessing global data
