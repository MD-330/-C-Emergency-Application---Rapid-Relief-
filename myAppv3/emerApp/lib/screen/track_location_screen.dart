...
class TrackLocationScreen extends StatefulWidget {
  @override
  _TrackLocationScreenState createState() => _TrackLocationScreenState();
}
...
String unit='كم';
  ...
  getMarker() async {
    _selectedMarkerImage =
        await bitmapDescriptorFromSvgAsset(context, 'assets/icons/map3.svg');
    ...
    if (mounted) {
      setState(() {
        distanceInMeters = Geolocator.distanceBetween(
            latitude, longitude, myLatitude, myLongitude);
        ...
        if(distanceInMeters>1000){
          ...
          // distanceInKMeters=distanceInKMeters.roundToDouble();
  ...
  getMyLocation() async {
    ...
    setState(() {
      // checkNoti
      // myLatitude = 21.450425880172546;
      // myLongitude =39.84813664108515;
      // // checkRequest
      // 21.43529177274625&39.85573433339596
      // myLatitude = 21.43529177274625;
      // myLongitude =39.85573433339596;
