...
class _SignupScreenState extends State<SignupScreen> with TickerProviderStateMixin {
  ...
  void _signUpFunction() async {                                                                // sing in function
    ...
    try {
      ...
      await Provider.of<AuthenticationController>(context, listen: false).signUp(userModel.email!, userModel.password!);
      if (globalUserId != null && globalUserId != '') {
        ...
        await Provider.of<UserDataController>(context, listen: false).registerUser(userModel).then((value) =>  // register
